...
from Detecteur_Input_Snake import *

port = 5670
agent_name = "Detecteur_Input_Snake"
...
def on_agent_event_callback(event, uuid, name, event_data, my_data):
    try:
        ...
        assert isinstance(agent_object, Detecteur_Input_Snake)
...
if __name__ == "__main__":
    ...
    igs.definition_set_class("Detecteur_Input_Snake")
