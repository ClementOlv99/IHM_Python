...
from Detecteur_Echap import *

port = 5670
agent_name = "Detecteur_Echap"
...
def on_agent_event_callback(event, uuid, name, event_data, my_data):
    try:
        ...
        assert isinstance(agent_object, Detecteur_Echap)
...
if __name__ == "__main__":
    ...
    igs.definition_set_class("Detecteur_Echap")
    ...
    agent = Detecteur_Echap()

    igs.observe_agent_events(on_agent_event_callback, agent)

    igs.output_create("pause_pressed", igs.BOOL_T, None)
