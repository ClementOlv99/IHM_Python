...
port = 5670
agent_name = "Generateur_Aleatoire"
...
# inputs
def Seed_input_callback(io_type, name, value_type, value, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Generateur_Aleatoire)
...
if __name__ == "__main__":
    ...
    igs.definition_set_class("Generateur_Aleatoire")
    ...
    agent = Generateur_Aleatoire()

    igs.observe_agent_events(on_agent_event_callback, agent)

    igs.input_create("seed", igs.INTEGER_T, None)
    igs.observe_input("seed", Seed_input_callback, agent)
