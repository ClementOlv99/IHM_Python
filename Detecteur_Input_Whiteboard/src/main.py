...
from Detecteur_Input_Whiteboard import *
...
def on_agent_event_callback(event, uuid, name, event_data, my_data):
    try:
        ...
        assert isinstance(agent_object, Detecteur_Input_Whiteboard)
...
if __name__ == "__main__":
    ...
    igs.definition_set_class("Detecteur_Input_Whiteboard")
    ...
    agent = Detecteur_Input_Whiteboard()
