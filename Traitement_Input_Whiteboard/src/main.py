    ...
    try:
        ...
        match refresh:
            ...
            case 1:
                ...
                agent.texte("S.N.A.K.E",300,0,"pantone")
                agent.texte("up key to go up",400,100,"darkred")
                agent.texte("down key to go down",400,200,"darkred")
                agent.texte("enter to validate",400,300,"darkred")
