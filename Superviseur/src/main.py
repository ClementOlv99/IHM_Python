...
# inputs
def New_Level_input_callback(io_type, name, value_type, value, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Superviseur)
        # add code here if needed
...
def Config_input_callback(io_type, name, value_type, value, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Superviseur)
...
if __name__ == "__main__":
    ...
    igs.definition_set_class("Superviseur")
