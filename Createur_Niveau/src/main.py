...
# inputs
def Element_Array_input_callback(io_type, name, value_type, value, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Createur_Niveau)
...
if __name__ == "__main__":
    ...
    igs.definition_set_class("Createur_Niveau")
    ...
    agent = Createur_Niveau()

    igs.observe_agent_events(on_agent_event_callback, agent)

    igs.input_create("element_array", igs.DATA_T, None)
    igs.observe_input("element_array", Element_Array_input_callback, agent)
    igs.input_create("layout", igs.DATA_T, None)
    igs.observe_input("layout", Layout_input_callback, agent)
