...
# services
def Settitle_callback(sender_agent_name, sender_agent_uuid, service_name, tuple_args, token, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Whiteboard)
        Title = tuple_args[0]
        agent_object.Settitle(sender_agent_name, sender_agent_uuid, Title)
    except:
        print(traceback.format_exc())


def Setbackgroundcolor_callback(sender_agent_name, sender_agent_uuid, service_name, tuple_args, token, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Whiteboard)
        Color = tuple_args[0]
        agent_object.Setbackgroundcolor(sender_agent_name, sender_agent_uuid, Color)
    except:
        print(traceback.format_exc())


def Getwindowsize_callback(sender_agent_name, sender_agent_uuid, service_name, tuple_args, token, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Whiteboard)
        agent_object.Getwindowsize(sender_agent_name, sender_agent_uuid)
    except:
        print(traceback.format_exc())


def Getwhiteboardsize_callback(sender_agent_name, sender_agent_uuid, service_name, tuple_args, token, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Whiteboard)
        agent_object.Getwhiteboardsize(sender_agent_name, sender_agent_uuid)
    except:
        print(traceback.format_exc())
...
def Chatas_callback(sender_agent_name, sender_agent_uuid, service_name, tuple_args, token, my_data):
    try:
        agent_object = my_data
        assert isinstance(agent_object, Whiteboard)
        Name = tuple_args[0]
        Message = tuple_args[1]
        agent_object.Chatas(sender_agent_name, sender_agent_uuid, Name, Message)
    except:
        print(traceback.format_exc())
...
if __name__ == "__main__":
    ...
    igs.definition_set_class("Whiteboard")
    ...
    igs.output_create("windowWidth", igs.INTEGER_T, None)
    igs.output_create("windowHeight", igs.INTEGER_T, None)
    igs.output_create("whiteboardWidth", igs.INTEGER_T, None)
    igs.output_create("whiteboardHeight", igs.INTEGER_T, None)
    ...
    igs.service_init("setTitle", Settitle_callback, agent)
    igs.service_arg_add("setTitle", "title", igs.STRING_T)
    igs.service_init("setBackgroundColor", Setbackgroundcolor_callback, agent)
    igs.service_arg_add("setBackgroundColor", "color", igs.STRING_T)
    igs.service_init("getWindowSize", Getwindowsize_callback, agent)
    igs.service_reply_add("getWindowSize", "getWindowSizeResult");
    igs.service_reply_arg_add("getWindowSize", "getWindowSizeResult", "width", igs.INTEGER_T);
    igs.service_reply_arg_add("getWindowSize", "getWindowSizeResult", "height", igs.INTEGER_T);
    igs.service_init("getWhiteboardSize", Getwhiteboardsize_callback, agent)
    igs.service_reply_add("getWhiteboardSize", "getWhiteboardSizeResult");
    igs.service_reply_arg_add("getWhiteboardSize", "getWhiteboardSizeResult", "width", igs.INTEGER_T);
    igs.service_reply_arg_add("getWhiteboardSize", "getWhiteboardSizeResult", "height", igs.INTEGER_T);
    igs.service_init("chat", Chat_callback, agent)
    igs.service_arg_add("chat", "message", igs.STRING_T)
    igs.service_init("chatAs", Chatas_callback, agent)
    igs.service_arg_add("chatAs", "name", igs.STRING_T)
    igs.service_arg_add("chatAs", "message", igs.STRING_T)
    igs.service_init("snapshot", Snapshot_callback, agent)
    igs.service_reply_add("snapshot", "snapshotResult");
    igs.service_reply_arg_add("snapshot", "snapshotResult", "base64Png", igs.DATA_T);
    ...
    igs.service_reply_add("addShape", "elementCreated");
    igs.service_reply_arg_add("addShape", "elementCreated", "elementId", igs.INTEGER_T);
    ...
    igs.service_reply_add("addText", "elementCreated");
    igs.service_reply_arg_add("addText", "elementCreated", "elementId", igs.INTEGER_T);
    ...
    igs.service_reply_add("addImage", "elementCreated");
    igs.service_reply_arg_add("addImage", "elementCreated", "elementId", igs.INTEGER_T);
    ...
    igs.service_reply_add("addImageFromUrl", "elementCreated");
    igs.service_reply_arg_add("addImageFromUrl", "elementCreated", "elementId", igs.INTEGER_T);
    igs.service_init("remove", Remove_callback, agent)
    igs.service_arg_add("remove", "elementId", igs.INTEGER_T)
    igs.service_reply_add("remove", "actionResult");
    igs.service_reply_arg_add("remove", "actionResult", "succeeded", igs.BOOL_T);
    ...
    igs.service_reply_add("translate", "actionResult");
    igs.service_reply_arg_add("translate", "actionResult", "succeeded", igs.BOOL_T);
    ...
    igs.service_reply_add("moveTo", "actionResult");
    igs.service_reply_arg_add("moveTo", "actionResult", "succeeded", igs.BOOL_T);
    ...
    igs.service_reply_add("setStringProperty", "actionResult");
    igs.service_reply_arg_add("setStringProperty", "actionResult", "succeeded", igs.BOOL_T);
    ...
    igs.service_reply_add("setDoubleProperty", "actionResult");
    igs.service_reply_arg_add("setDoubleProperty", "actionResult", "succeeded", igs.BOOL_T);
    igs.service_init("getElementIds", Getelementids_callback, agent)
    igs.service_reply_add("getElementIds", "elementIds");
    igs.service_reply_arg_add("getElementIds", "elementIds", "jsonArray", igs.STRING_T);
    igs.service_init("getElements", Getelements_callback, agent)
    igs.service_reply_add("getElements", "elements");
    igs.service_reply_arg_add("getElements", "elements", "jsonArray", igs.STRING_T);
